...
Compare Meta Llama model with IBM Granite model by loading these [4 notebooks](https://github.com/IBM/granite-workshop/tree/main/notebooks) to colab. For instructions, follow https://ibm.github.io/granite-workshop/ 
